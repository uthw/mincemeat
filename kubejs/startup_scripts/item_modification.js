onEvent("item.modification", (event) => {
    ...
    event.modify("#minecraft:music_discs", (item) => {
        item.maxStackSize = 16;
    });
    ...
    // spartan silver fix
    event.modify("#spartanweaponry:silver_weapons", (item) => {
        item.maxDamage = 460;
    });
    event.modify("spartanweaponry:shield_basic_silver", (item) => {
        item.maxDamage = 800;
    });
    event.modify("spartanweaponry:shield_tower_silver", (item) => {
        item.maxDamage = 800;
    });
