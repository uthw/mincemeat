...
projectvibrantjourneys:fir_sapling
projectvibrantjourneys:pine_sapling
projectvibrantjourneys:palm_sapling
projectvibrantjourneys:willow_sapling
projectvibrantjourneys:mangrove_sapling
projectvibrantjourneys:redwood_sapling
projectvibrantjourneys:baobab_sapling
projectvibrantjourneys:aspen_sapling
projectvibrantjourneys:red_maple_sapling
projectvibrantjourneys:orange_maple_sapling
projectvibrantjourneys:purple_maple_sapling
projectvibrantjourneys:cottonwood_sapling
projectvibrantjourneys:juniper_sapling
projectvibrantjourneys:pink_sakura_sapling
projectvibrantjourneys:white_sakura_sapling
projectvibrantjourneys:tamarack_sapling
projectvibrantjourneys:joshua_sapling
...
abundance:jacaranda_sapling
abundance:redbud_sapling
abundance:flowering_redbud_sapling
...
terraincognita:apple_sapling
terraincognita:hazel_sapling
...
# Join the lines with commas and wrap each line in double quotes
output_string = ', '.join(f'"{line}"' for line in lines)
